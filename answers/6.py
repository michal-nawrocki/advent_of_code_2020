...
input = [
    ...
    "aiqush",
    "fbmtw",
    "", # Added extra empty string to simplify grouping of answers
]
...
def part_two():
    ...
    for line in input:
        if not line is "":
            ...
            # Include the answer if everyone said 'yes' to it
            counted_yes += len([x for x in group_answers.values() if x == people_in_group])
            people_in_group = 0
            group_answers = Counter()
